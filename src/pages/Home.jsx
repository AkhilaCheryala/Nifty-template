            ...
            <h4>Moving averages</h4>
             ...
             <div className="bar-values">
              ...
              <p className="view-more">view more<span className="bi bi-caret-down-fill"></span> </p>
                ...
                <div className="values"><p><span className="s">S</span>SMA(5)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">S</span>EMA(15)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">S</span>SMA(20)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">B</span>EMA(7)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">S</span>EMA(8)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">S</span>EMA(22)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">B</span>SMA(50)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">B</span>EMA(21)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">B</span>SMA(5)</p><p className="values-2">19999.40</p></div>
                <div className="values"><p><span className="s">N</span>Ichimoku Baseline(2,6,15,23)</p><p className="values-2">19999.40</p></div>
            ...
            <h4>Oscillators</h4>
             ...
             <div className="bar-values">
              ...
              <div className="values-grid_2">
                ...
                <div className="values"><p><span className="s">N</span>CCI(20)</p><p className="values-2"> 7.33</p></div>
                <div className="values"><p><span className="s">B</span>Momentum(7)</p><p className="values-2">-86.46</p></div>
